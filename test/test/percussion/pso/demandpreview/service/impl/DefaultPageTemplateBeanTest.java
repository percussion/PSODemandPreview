...
public class DefaultPageTemplateBeanTest {
	...
	public void setUp() throws Exception {
		...
		objFinder = context.mock(IPSOObjectFinder.class); 
		cut.setObjFinder(objFinder);
		tempSvc = context.mock(IPSTemplateService.class); 
	...
	public void testFindTemplateSingle() {
		...
		final IPSGuid contentId = context.mock(IPSGuid.class); 
	...
	public void testFindTemplateMulti() {
		...
		final IPSAssemblyTemplate t3 = context.mock(IPSAssemblyTemplate.class);
