...
{
	 private static Log log = LogFactory.getLog(SiteEditionLookUpServiceImpl.class);
	 ...
	 /**
	  * 
	  * @see com.percussion.pso.occ.zippreview.service.SiteEditionLookUpService#LookUpSiteEdition(com.percussion.utils.guid.IPSGuid)
	  */
