...
{
   private static Log log = LogFactory.getLog(DemandPublisherBeanTest.class);
   ...
   public final void testQueueDemandWork()
   {
        ...
        final IPSGuid content = context.mock(IPSGuid.class);
        final IPSGuid folder = context.mock(IPSGuid.class);
        final IPSGuid editionId = context.mock(IPSGuid.class);
   ...
   private class TestableDemandPublisherBean extends DemandPublisherBean
   {
      ...
      /**
       * @see com.percussion.pso.occ.zippreview.service.impl.DemandPublisherBean#setRxPubSvc(com.percussion.rx.publisher.IPSRxPublisherService)
       */
      @Override
